...
export default function PhysioLaumone() {
  const router = useRouter();
  const sitePhone = "01481 256517";
  // Put your booking link here (or leave empty to trigger call fallback)
  const bookingLink = "https://patient.england.medicus.health/385291/booking/public/01987c6a-f5af-73af-a74f-1f6edac5c4ea";
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Physiotherapy – L'Aumone</Text>
