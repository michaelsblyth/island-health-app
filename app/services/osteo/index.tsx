...
export default function OsteoMenu() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <Text style={styles.title}>Osteopathy</Text>
        <Text style={styles.subtitle}>Choose a location</Text>

        <TouchableOpacity style={styles.button} onPress={() => router.push("/services/osteo/laumone")}>
          <Text style={styles.buttonText}>L'Aumone</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.button} onPress={() => router.push("/services/osteo/stsampsons")}>
          <Text style={styles.buttonText}>St Sampson’s</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.button} onPress={() => router.push("/services/osteo/town")}>
