...
export default function OsteoLaumone() {
  const router = useRouter();
  const sitePhone = "01481 256517";
  const bookingLink = "https://patient.england.medicus.health/385291/booking/public/01987c6a-339b-705a-9ef4-692592f065e9";
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Osteopathy – L'Aumone</Text>
