...
export default function GPStsampsons() {
  const router = useRouter();
  const sitePhone = "01481 245915";

  const singleLink = "https://patient.england.medicus.health/385291/booking/public/0198798b-85f2-73b3-b480-a2dbcaf81d81";
  const doubleLink = ""; // Add this when ready

  const handlePress = (bookingLink?: string) => {
    if (bookingLink) {
      router.push({
        pathname: "/webview",
        params: { url: bookingLink },
      });
    } else {
      Alert.alert(
        "Call to book",
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>GP Appointments – St Sampsons</Text>

      <TouchableOpacity style={styles.button} onPress={() => handlePress("https://patient.england.medicus.health/385291/booking/public/0198798b-85f2-73b3-b480-a2dbcaf81d81")}>
