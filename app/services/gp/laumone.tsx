...
export default function GPLaumone() {
  const router = useRouter();
  const sitePhone = "01481 256517";

  const singleLink = "https://patient.england.medicus.health/385291/booking/public/01985dca-5231-7308-9b31-63272c419bcb";
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>GP Appointments – L'Aumone</Text>

      <TouchableOpacity style={styles.button} onPress={() => handlePress("https://patient.england.medicus.health/385291/booking/public/01985dca-5231-7308-9b31-63272c419bcb")}>
