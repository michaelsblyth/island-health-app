  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <Text style={styles.title}>Nurse Appointments</Text>
        <Text style={styles.subtitle}>Choose a location</Text>

        <TouchableOpacity style={styles.button} onPress={() => router.push("/services/nurse/laumone")}>
          <Text style={styles.buttonText}>L'Aumone</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.button} onPress={() => router.push("/services/nurse/stsampsons")}>
          <Text style={styles.buttonText}>St Sampson’s</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.button} onPress={() => router.push("/services/nurse/town")}>
